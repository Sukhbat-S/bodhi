...
const PROMPTS: Record<BriefingType, string> = {
  morning: `Generate a morning briefing for the user.

Below are their recent memories, today's calendar, inbox, and connected service data.

Your job: give them a clear picture of their day, notice what their energy is flowing toward, and close with one reflective question.

Guidelines:
- Be observational — mirror what you see, don't prescribe or motivate
- Include schedule, inbox, and service data if provided — skip sections with no data
- Keep it concise (under 200 words)
- Use Markdown formatting`,

  evening: `Generate an evening reflection for the user.

Below are today's memories, calendar events, and inbox activity.

Your job: reflect on what actually happened today and close with one question.

Guidelines:
- Be honest and observational — no cheerleading
- Include service data if provided — skip what's missing
- Keep it concise (under 150 words)
- Use Markdown formatting`,

  weekly: `Generate a weekly synthesis for the user.

Below are memories from the past week, plus calendar, inbox, and connected service context.

Your job: surface patterns — what's growing, what's fading, what needs attention.

Guidelines:
- Notice patterns across projects, decisions, and energy — don't prescribe actions
- Flag stalled decisions or neglected knowledge if visible in the data
