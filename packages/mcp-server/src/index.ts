...
server.tool(
  "search_memories",
  "Search BODHI's memory using semantic vector search. Use this to find what was discussed, decided, or learned in past conversations. Returns memories ranked by relevance.",
  {
...
server.tool(
  ...
  "Get recent conversations with BODHI. Shows what's been discussed, priorities, questions, and plans. Useful at session start for context.",
  {
...
server.tool(
  "get_todays_context",
  "Get context for today: calendar events, unread emails, and BODHI system status. Quick situational awareness.",
  {},
  async () => {
...
server.tool(
  "get_insights",
  "Get analytical insights from BODHI's memory: tag trends, stalled decisions, neglected high-value memories, and activity rates. Useful for understanding focus areas and what needs attention.",
  {},
  async () => {
