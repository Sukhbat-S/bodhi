...
// Set BODHI_PROJECT_DIR to register an external project
const externalProjectPath = process.env.BODHI_PROJECT_DIR;
if (externalProjectPath) {
  PROJECTS["external-project"] = {
    name: process.env.BODHI_PROJECT_NAME || "External Project",
    path: externalProjectPath,
    description: process.env.BODHI_PROJECT_DESCRIPTION || "External project",
    defaultBranch: "main",
